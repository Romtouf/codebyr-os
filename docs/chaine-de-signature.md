...
| Phrase de passe | Aucune (`--passphrase ''` était écrit dans `publish-apt.sh`) | Un vol de fichiers suffit à signer à la place du projet |
...
- [ ] Phrase de passe sur la clé de signature
