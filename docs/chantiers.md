...
| 🟠 | **Personnel et Travail indiscernables pour les daltoniens** | Azur `#4E8FEF` et Améthyste `#8F6CF0` : écart CIEDE2000 de **2,7** en deutéranopie, **6,7** en protanopie — la même couleur pour la plupart des daltoniens. Contrairement à Jetable, aucun motif ne les distingue. **Décision de conception** : changer une teinte, ou donner à l'un des deux un second repère que la couleur (motif, forme de pastille). Chiffré par `tests/test_contraste.py` | S |
